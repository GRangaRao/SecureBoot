  ...
  )
{
  ...
  return ((UINTN) 0xE0000000 + (UINTN) (Bus << 20) + (UINTN) (Device << 15) + (UINTN) (Function << 12));
}
  ...
  )
{
  ...
  DEBUG((DEBUG_INFO,"FlashRegionSize %X\n", FlashRegionSize));
  

DEBUG((DEBUG_INFO,"HardwareSpiAddr Address %X %X\n", HardwareSpiAddr,Address));
  HardwareSpiAddr += Address;
...
DEBUG((DEBUG_INFO,"FlashRegionSize %X\n", FlashRegionSize));
  ...
  DEBUG((DEBUG_INFO,"HardwareSpiAddr %X\n", HardwareSpiAddr));
    //
  ...
  DEBUG((DEBUG_INFO,"Send Spi Cmd Status %\n", Status));
    //
...
SendSpiCmdEnd:
  ...
  DEBUG((DEBUG_INFO,"Send Spi Cmd Status %X\n", Status));
  return Status;
}
